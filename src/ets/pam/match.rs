...
// #endif
    ...
    // #endif
        ...
        match pc {
            ...
            // }
            Opcode::Tuple(n) => { // *ep is a tuple of arity n
            ...
            Opcode::PushT(n) => { // *ep is a tuple of arity n, push ptr to first element
                if !is_tuple(*ep) {
                    FAIL();
                }
                tp = tuple_val(*ep);
            ...
            */
            ...
            //     }
            // }
            Opcode::Catch() => {  // Match success, now build result
                do_catch = true;
                if in_flags & ERTS_PAM_COPY_RESULT {
                    build_proc = c_p;
                    if esdp {
